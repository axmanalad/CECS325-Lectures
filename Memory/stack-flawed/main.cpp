...
int main() {
    ...
    // When a CharStack that is destroyed, the dynamic storage array it created
    // is NOT destroyed. This is a memory leak. We need to program the CharStack
    // to clean up after itself, by releasing "resources" that it needed to do
    // its work, such as values in dynamic storage.
    return 0;
}
